...
def process_frames(frame_queue, result_queue, yolo_model, openimages_model, classes,classes_openimages):
    while True:
...
def main():
    ...
    # Load YOLO model
    yolo_weights_file = f"{current_directory}/Camera Video Analysis Module/yolo/yolov3.weights"
    yolo_config_file = f"{current_directory}/Camera Video Analysis Module/yolo/cfg/yolov3.cfg"
    openimages_weights_file = f"{current_directory}/Camera Video Analysis Module/yolo/yolov3-openimages.weights"
    openimages_config_file = f"{current_directory}/Camera Video Analysis Module/yolo/cfg/yolov3-openimages.cfg"
    ...
    process = multiprocessing.Process(target=process_frames, args=(frame_queue, result_queue, yolo_neural_network,openimages_model, classes,classes_openimages))
    process.start()
