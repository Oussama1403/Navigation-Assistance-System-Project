...
def process_frames(frame_queue, result_queue, classes):
    yolo_neural_network = load_yolo_model(os.path.join(os.getcwd(),"Camera Video Analysis Module","yolo","yolov3-openimages.weights"),os.path.join(os.getcwd(), "Camera Video Analysis Module", "yolo", "cfg", "yolov3-openimages.cfg"))
...
def main():
    ...
    process = multiprocessing.Process(target=process_frames, args=(frame_queue, result_queue, classes))
    process.start()
